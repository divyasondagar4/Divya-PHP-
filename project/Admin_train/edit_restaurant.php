                            ...
                            <form role="form"  method="post" enctype="multipart/form-data">
									...
									<div class="form-group">
                                     ...
                                     <p class="help-block">Enter Restaurant name here.</p>
                                            ...
                                            <div class="form-group">
                                            <label>address</label>
                                            <input class="form-control" rows="3" name="address" value="<?php echo $fetch->address;?>"></input>
                                        </div>
                                        <div class="form-group">
                                            <label>image</label>
                                            <input class="form-control" type="file" name="image" > <img src="assets/img/restaurant/<?php echo $fetch->image?>" width="50px">
										...
										<div class="form-group">
                                            ...
                                            <select name="city_id" class="form-control" value="<?php echo $fetch->city_name; ?>">
