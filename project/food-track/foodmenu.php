                            ...
                            <div class="media align-items-center  text-lg-left flex-column flex-lg-row" style="display: flex; width:100%;">
                                ...
                                <div class="media-body">
                                    ...
                                    <div class="mt-3 mt-lg-0 ml-lg-3 text-center">
                                        <h3 class="mb-0 font-weight-semibold">350 rs</h3>
            ...
            <div class="card card-body " style=" width:100%;">
                <div class="media align-items-center  text-lg-left flex-column flex-lg-row" style="display: flex; width:100%;">
                    ...
                    <div class="media-body">
                        ...
                        <div class="mt-3 mt-lg-0 ml-lg-3 text-center">
                            <h3 class="mb-0 font-weight-semibold">250 rs</h3>
            ...
            <div class="card card-body " style=" width:100%;">
                <div class="media align-items-center  text-lg-left flex-column flex-lg-row" style="display: flex; width:100%;">
                    ...
                    <div class="media-body">
                        ...
                        <p class="mb-3">500 g</p>

                        <div class="mt-3 mt-lg-0 ml-lg-3 text-center">
                            <h3 class="mb-0 font-weight-semibold">400 rs</h3>
                ...
                <button type="button" class="btn btn-warning mt-4 tect-black"><i class="icon-cart-add mr-2"></i>  <a href="cart" style="color:black;">Add to cart</button>
                <button type="button" class="btn btn-info mt-4 tect-black"> <a href="foodmenu" style="color:black;"> view cart</button>
