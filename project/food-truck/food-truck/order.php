                ...
                <div class="ORDER-form">
                    ...
                    <form>
                        <div class="input-group">
                            ...
                            <input type="text" id="enter-train-no" name="enter-train-no" placeholder="Enter Train No " required>
                        </div>
                        <div class="input-group">
            ...
            <div class="ORDER-form2">
                ...
                <form>
                    <div class="input-group">
                        ...
                        <input type="text" id="enter-pnr" name="enter-pnr" placeholder="Enter 10 Digit PNR " required>
                    </div>
